 ...
 * @author LucasMarcon
 */
public class excluirCliente1 extends javax.swing.JPanel {

	/**
	 * Creates new form excluirCliente1
	 */
	public excluirCliente1() {
		initComponents();
	...
	@SuppressWarnings("unchecked")
      ...
      private void initComponents() {
            ...
            labelTitulo.setText("Exclusão de Clientes");
      ...
      private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
		...
		if (!"Selecione um campo".equals(jComboBox1.getSelectedItem() + "")) { // Castzinho maroto
			...
			//
			//                        cc.excluirCliente(jTextField1.getText());
	...
	private void limparTabela(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoLimparBuscaActionPerformed
...
public class excluirCliente1 extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        labelTitulo.setText("Excluir Clientes");
        ...
        jPanel1.add(botaoLimpar, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 420, -1, -1));
    ...
    private void jTableExcluirMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableExcluirMouseClicked
        ...
        int[] linha = jTableExcluir.getSelectedRows();

        if (linha.length == 1) {

            try {

                textFieldIdCliente.setText(jTableExcluir.getValueAt(linha[0], 0) + "");
                textFieldNomeContato.setText(jTableExcluir.getValueAt(linha[0], 1) + "");
                textFieldRazaoSocial.setText(jTableExcluir.getValueAt(linha[0], 2) + "");
                textFieldCnpj.setText(jTableExcluir.getValueAt(linha[0], 3) + "");
                textFieldEmail.setText(jTableExcluir.getValueAt(linha[0], 4) + "");
                textFieldTelefone.setText(jTableExcluir.getValueAt(linha[0], 5) + "");
                textFieldEstado.setText(jTableExcluir.getValueAt(linha[0], 6) + "");
                textFieldCidade.setText(jTableExcluir.getValueAt(linha[0], 7) + "");
                textFieldCep.setText(jTableExcluir.getValueAt(linha[0], 8) + "");
                textFieldRua.setText(jTableExcluir.getValueAt(linha[0], 9) + "");
            } catch (Exception e) {
                JOptionPane.showMessageDialog(null, "Erro ao popular tabela! " + e.getMessage());
            }
        }
    ...
    private void botaoLimparActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoLimparActionPerformed
        ...
        try {
            ...
            if (resposta == JOptionPane.YES_NO_OPTION) {
                ...
                cc.excluirCliente(cliente.getIdCliente());
