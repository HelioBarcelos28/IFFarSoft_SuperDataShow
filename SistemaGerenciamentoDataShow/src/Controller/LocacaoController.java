...
public class LocacaoController {
	...
	public String alterarLocacao(Locacao locacao, String id) {
	...
	public String alterarLocacaoValorLocacao(Locacao locacao, String id) {
	...
	public String alterarLocacaoDataLocacao(Locacao locacao, String id) {
	...
	public String alterarLocacaoDataDevolucaoPrevista(Locacao locacao, String id) {
	...
	public String alterarLocacaoDataDevolucao(Locacao locacao, String id) {
	...
	public String alterarLocacaoHorasUsadas(Locacao locacao, String id) {
	...
	public String alterarLocacaoIdProjetor(Locacao locacao, String id) {
	...
	public String alterarLocacaoIdCliente(Locacao locacao, String id) {
	...
	public String alterarLocacaoValorMulta(Locacao locacao, String id) {
	...
	public ArrayList<Locacao> listarTodasLocacoes() {
		...
		String SQL = "SELECT * FROM Locacao ORDER BY 1 ASC;";
		...
		try {
			...
			if (rs != null) {
				...
				while (rs.next()) {
					...
					locacao.setIdCliente			(rs.getString("idLocacao"));
	...
	*/
	public ArrayList<Locacao> listarLocacoesEspecificasValorLocacao(String valorLocacao, int ordenarCrescenteDecrescente) {
		...
		if (ordenarCrescenteDecrescente == 1) {
			...
			SQL += " ORDER BY valorLocacao DESC";
		} else {
			
			SQL += " ORDER BY valorLocacao ASC";
		}
	...
	*/
	public ArrayList<Locacao> listarLocacoesEspecificasDataLocacao(String dataLocacao, int ordenarCrescenteDecrescente) {
		...
		if (ordenarCrescenteDecrescente == 1) {
			...
			SQL += " ORDER BY dataLocacao DESC";
		} else {
			
			SQL += " ORDER BY dataLocacao ASC";
		}
	...
	*/
	public ArrayList<Locacao> listarLocacoesEspecificasDataDevolucaoPrevista(String dataDevolucaoPrevista, int ordenarCrescenteDecrescente) {
		...
		if (ordenarCrescenteDecrescente == 1) {
			...
			SQL += " ORDER BY dataDevolucaoPrevista DESC";
		} else {
			
			SQL += " ORDER BY dataDevolucaoPrevista ASC";
		}
	...
	*/
	public ArrayList<Locacao> listarLocacoesEspecificasDataDevolucao(String dataDevolucao, int ordenarCrescenteDecrescente) {
		...
		if (ordenarCrescenteDecrescente == 1) {
			...
			SQL += " ORDER BY dataDevolucao DESC";
		} else {
			
			SQL += " ORDER BY dataDevolucao ASC";
		}
	...
	*/
	public ArrayList<Locacao> listarLocacoesEspecificasHorasUsadas(String horasUsadas, int ordenarCrescenteDecrescente) {
		...
		if (ordenarCrescenteDecrescente == 1) {
			...
			SQL += " ORDER BY horasUsadas DESC";
		} else {
			
			SQL += " ORDER BY horasUsadas ASC";
		}
	...
	*/
	public ArrayList<Locacao> listarLocacoesEspecificasIdLocacao(String idLocacao, int ordenarCrescenteDecrescente) {
		...
		if (ordenarCrescenteDecrescente == 1) {
			...
			SQL += " ORDER BY idLocacao DESC";
		} else {
			
			SQL += " ORDER BY idLocacao ASC";
		}
	...
	*/
	public ArrayList<Locacao> listarLocacoesEspecificasValorMulta(String valorMulta, int ordenarCrescenteDecrescente) {
		...
		if (ordenarCrescenteDecrescente == 1) {
			...
			SQL += " ORDER BY valorMulta DESC";
		} else {
			
			SQL += " ORDER BY valorMulta ASC";
		}
