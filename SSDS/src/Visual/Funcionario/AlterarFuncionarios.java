...
/*
 * AlteraFuncionarios.java
 *
 * Created on 21/06/2014, 12:44:01
 */
package Visual;
 ...
 * @author helio
 */
public class AlterarFuncionarios extends javax.swing.JPanel {

    /** Creates new form AlteraFuncionarios */
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 102), 3, true), "Alterar Funcionários", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 24), new java.awt.Color(0, 102, 0))); // NOI18N
...
String validacao = "Campos Obrigatórios";
  ...
  try {
        if (jTable1.getSelectedRow() != -1) {
            ...
            funcionariosdados  BancoDados = new funcionariosdados();
            
            X.setIdfunionarios(Integer.parseInt(jTextFieldIdfuncionario.getText()));
            ...
            dtm.setValueAt(Integer.parseInt(jTextFieldIdfuncionario.getText()), jTable1.getSelectedRow(), 0);
            dtm.setValueAt(jTextFieldNome.getText(), jTable1.getSelectedRow(), 1);
            dtm.setValueAt(jComboBoxSetor.getSelectedItem(), jTable1.getSelectedRow(), 2);
           ...
           dtm.setValueAt(jComboBoxDiaNasc.getSelectedItem()+"/"+jComboBoxMesNasc.getSelectedItem()+"/"+jComboBoxAnoNasc.getSelectedItem(), jTable1.getSelectedRow(), 5);
            ...
            dtm.setValueAt(Float.parseFloat(jTextFieldSalario.getText()), jTable1.getSelectedRow(), 9);
...
//COPIE OCOMANDO ACIMA E COLE UM PARA CAMPO DO FORM
